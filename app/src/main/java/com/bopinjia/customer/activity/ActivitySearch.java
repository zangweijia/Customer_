...
public class ActivitySearch extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        timer.schedule(new TimerTask() {
            public void run() {
                InputMethodManager inputManager = (InputMethodManager) mEdtSearch.getContext().getSystemService(Context.INPUT_METHOD_SERVICE);
                inputManager.showSoftInput(mEdtSearch, 0);
            }
        }, 500);
