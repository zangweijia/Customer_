...
public class ActivityFXSStoreInfo extends BaseActivity implements IOnSelectModeDismissListner {
    ...
    private void setTitle() {
        ...
        if (getIntent().hasExtra("isFxSuccess")) {
        ...
        public void onResponse(String result) {
            try {
                ...
                if (jsonresult.equals("1")) {
                    ...
                    mEdtIntroducr.setText(Data.getString("MDGDSM_PrimaryBusiness").equals("0")? "":Data.getString("MDGDSM_PrimaryBusiness"));
                    mEdtIntroducr.setSelection(mEdtIntroducr.getText().toString().length());

                    mName.setText(Data.getString("MDGDSM_ShopContact").equals("0")? "":Data.getString("MDGDSM_ShopContact"));
                    mName.setSelection(mName.getText().toString().length());

                    mShopName.setText(Data.getString("MDGDSM_ShopName").equals("0")? "":Data.getString("MDGDSM_ShopName"));
                    mShopName.setSelection(mShopName.getText().toString().length());

                    mPhone.setText(Data.getString("MDGDSM_ShopMobile").equals("0")? "":Data.getString("MDGDSM_ShopMobile"));

                    mEtAddress.setText(Data.getString("MDGDSM_Address").equals("0")?"":Data.getString("MDGDSM_Address"));
