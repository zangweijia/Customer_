...
public class ActivityFXCommissionProduct extends BaseActivity {
    ...
    // private AdapterCommissionProduct mAdapter;

    AdapterCommissionProductList mAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.wj_act_commission_product);
    ...
    private void init() {
        mProduct = (ListView) findViewById(R.id.lst_comission_product);
        ...
        mProduct.setOnItemClickListener(new OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View arg1, int position, long arg3) {
                ...
                if (position == 0) {
                    ...
                    ii.setClass(ActivityFXCommissionProduct.this, ActivityProductDetailsNew.class);
                    startActivity(ii);
                }
            }
        });
    ...
    private void getCommissiomProductList(int index, final int id) {
        ...
        String url = Constants.WEBAPI_ADDRESS + "api/Commission/List_GDS?UserId=" + getLoginUserId() + "&StateId=1"
                + "&TypeId=" + typeid + "&PageIndex=" + String.valueOf(index) + "&PageSize=" + "20" + "&Sign="
        ...
        public void onResponse(String result, int id, String str) {
            try {
                ...
                if (jsonresult.equals("1")) {
                    mIncludeNull.setVisibility(View.GONE);
                    mProduct.setVisibility(View.VISIBLE);
                    parseproductList(result, id);
                } else {
                    mIncludeNull.setVisibility(View.VISIBLE);
    ...
    private void MdAdvertising() {
        ...
        String url = Constants.WEBAPI_ADDRESS + "api/MdAdvertising/Detail?ModuleId=" + "79" + "&Sign="
