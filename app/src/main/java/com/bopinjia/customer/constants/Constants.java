...
public class Constants {
	...
	/** 获取验证码的意图:修改密码 */
	public static final String SECURITY_INTENT_CHANGE_PASS = "0";
	/** 获取验证码的意图:更换手机号 */
	public static final String SECURITY_INTENT_CHANGE_PHONE = "1";
	/** 获取验证码的意图:注册 */
	public static final String SECURITY_INTENT_REGISTRATION = "2";
