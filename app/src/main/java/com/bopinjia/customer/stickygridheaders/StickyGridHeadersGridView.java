...
package com.bopinjia.customer.stickygridheaders;
...
import com.bopinjia.customer.stickygridheaders.StickyGridHeadersBaseAdapterWrapper.HeaderFillerView;
...
public class StickyGridHeadersGridView extends GridView implements OnScrollListener, OnItemClickListener,
    ...
    private void measureHeader() {
        ...
        if (mHeadersIgnorePadding) {
            ...
            mStickiedHeader.layout(getLeft() + getPaddingLeft(), 0, getRight() - getPaddingRight(), mStickiedHeader
                            .getMeasuredHeight());
        }
    }
    ...
    void attachHeader(View header) {
        ...
        try {
            ...
            Method method = View.class.getDeclaredMethod("dispatchAttachedToWindow", Class
                            .forName("android.view.View$AttachInfo"), Integer.TYPE);
